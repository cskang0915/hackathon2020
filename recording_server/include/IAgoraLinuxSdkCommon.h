...
/** Error codes.
 ...
 @note When using the Agora Recording SDK, you may also receive error codes from the Agora Native SDK. See more [error codes](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/cpp/namespaceagora.html#a8affb9bb02864d82c4333529dc3d75a1).
 */
...
enum LEAVE_PATH_CODE {
    ...
    /** 4: The recording application calls the \ref agora::recording::IRecordingEngine::leaveChannel "leaveChannel" method to leave the channel.  */
    LEAVE_CODE_CLIENT_LEAVE = 1 << 4,
};

/** Warning codes.
 @note When using the Agora Recording SDK, you may also receive warning codes from the Agora Native SDK. See more [warning codes](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/cpp/namespaceagora.html#a32d042123993336be6646469da251b21).
 */
enum WARN_CODE_TYPE {
...
/** Mix audio and video in real time. Takes effect only when the \ref agora::recording::RecordingConfig#isMixingEnabled "isMixingEnabled" is set as true.
 ...
 See the [Supported Players](https://docs.agora.io/cn/faq/recording_player).
 */
