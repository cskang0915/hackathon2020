 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_io_agora_recording_RecordingSDK_nativeLeaveChannel
 ...
 */
JNIEXPORT jint JNICALL Java_io_agora_recording_RecordingSDK_nativeSetVideoMixingLayout
 ...
 */
JNIEXPORT jobject JNICALL Java_io_agora_recording_RecordingSDK_nativeGetProperties(JNIEnv * env, jobject, jlong nativeObjectRef){
  jniproxy::AgoraJniProxySdk* nativeHandle = reinterpret_cast<jniproxy::AgoraJniProxySdk*>(nativeObjectRef);
  if(!nativeHandle){
    return JNI_FALSE;
  }
 ...
 */
JNIEXPORT jint JNICALL Java_io_agora_recording_RecordingSDK_nativeSetUserBackground(JNIEnv * env, jobject job, jlong nativeObjectRef, jint juid, jstring jpath){
    jniproxy::AgoraJniProxySdk* nativeHandle = reinterpret_cast<jniproxy::AgoraJniProxySdk*>(nativeObjectRef);
    if(nativeHandle) {
        int uid = (int)juid;
        std::string path;
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_io_agora_recording_RecordingSDK_nativeSetLogLevel
 ...
 * Signature: (J)V
 */
 JNIEXPORT jint JNICALL Java_io_agora_recording_RecordingSDK_nativeStartService(JNIEnv * env, jobject job, jlong nativeObjectRef){
   jniproxy::AgoraJniProxySdk* nativeHandle = reinterpret_cast<jniproxy::AgoraJniProxySdk*>(nativeObjectRef);
   if(nativeHandle){
 ...
 * Signature: (J)V
 */
JNIEXPORT jint JNICALL Java_io_agora_recording_RecordingSDK_nativeStopService(JNIEnv * env, jobject job, jlong nativeObjectRef){
  jniproxy::AgoraJniProxySdk* nativeHandle = reinterpret_cast<jniproxy::AgoraJniProxySdk*>(nativeObjectRef);
  if(nativeHandle){
