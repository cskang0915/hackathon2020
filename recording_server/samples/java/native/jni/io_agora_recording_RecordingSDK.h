 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_io_agora_recording_RecordingSDK_nativeStartService
  (JNIEnv *, jobject, jlong);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_io_agora_recording_RecordingSDK_nativeStopService
  (JNIEnv *, jobject, jlong);
 ...
 */
JNIEXPORT jobject JNICALL Java_io_agora_recording_RecordingSDK_nativeGetProperties
  (JNIEnv *, jobject, jlong);
 ...
 */
JNIEXPORT jint JNICALL Java_io_agora_recording_RecordingSDK_nativeSetUserBackground
